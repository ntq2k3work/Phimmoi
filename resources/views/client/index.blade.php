...
<html lang="vi">
   <head>
      ...
      <link rel='stylesheet' id='bootstrap-css' href="{{ asset('assets/css/bootstrap.min.css?ver=5.7.2') }}" media='all' />
      <link rel='stylesheet' id='style-css' href="{{ asset('assets/css/style.css?ver=5.7.2') }}" media='all' />
      <link rel='stylesheet' id='wp-block-library-css' href="{{ asset('assets/css/style.min.css?ver=5.7.2') }}" media='all' />
      <script type='text/javascript' src="{{ asset('assets/js/jquery.min.js?ver=5.7.2') }}" id='halim-jquery-js'></script>
